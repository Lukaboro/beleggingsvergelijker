          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="bg-blue-100 rounded-full w-16 h-16 max-w-[64px] max-h-[64px] flex items-center justify-center mx-auto mb-4">
                  <svg
                    className="text-blue-600 w-2/3 h-2/3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
